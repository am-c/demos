...
function init() {
  ...
  $('.not').click(function() {
    ...
    $('.top-text').html('Click each block for a definition of each category. <br/> <span class="sh-subtext">*The higher the scale the more effective.</span>');
  });
  /* },
   function() {
